...
// const passwordEls = document.querySelectorAll('input[type="password"]'); //NodeList
...
// function getId()
// {
//     Event.observe("input","click",afficherID);
//     function afficherID(evt)
//     {
//         elementClic = Event.element(evt);
//         var myID = elementClic.id;
//     }
// }
...
form.addEventListener('input', debounce(function (e) {
    ...
    //On récupère tous les id des input des passwords pour pouvoir les réutiliser dans le switch
    // let passwordIds = [];
    // for (const x of passwordEls) {
    //     let i = 0;
    //     passwordIds.push(passwordEls[i].id);
