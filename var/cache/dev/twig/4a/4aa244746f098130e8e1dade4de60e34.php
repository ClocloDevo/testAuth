...
";
    ...
    ";
        // line 9
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 9, $this->source); })()), 'form_start', ["attr" => ["id" => "signup"]]);
        echo "
        <div class=\"row\">
            <div class=\"col-12\">
                ";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 12, $this->source); })()), "lastname", [], "any", false, false, false, 12), 'row', ["label" => "Nom"]);
        // line 14
        echo "
            </div>
        </div>
        ...
        echo "
                ";
        // line 27
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 27, $this->source); })()), "plainPassword", [], "any", false, false, false, 27), 'row', ["attr" => ["id" => "inputPassword"]]);
        // line 29
        echo "
                <span class=\"error\" aria-live=\"polite\"></span>
            </div>
...
{% block content %}
    <h1>Inscription</h1>
{#    {{ form(registrationForm, {'attr': {'id': 'signup'}}) }}#}

    {{ form_start(registrationForm, {'attr': {'id': 'signup'}}) }}
        <div class=\"row\">
            <div class=\"col-12\">
        ...
        <div class=\"row\">
            <div class=\"col-12\">
                ...
                {{ form_row(registrationForm.plainPassword,  {'attr': {'id': 'inputPassword'}}, {
                    label: 'Mot de passe'
                }) }}
                <span class=\"error\" aria-live=\"polite\"></span>
            </div>
...
{#        <button type=\"submit\" class=\"btn\">S'inscrire</button>#}
    ...
    <p>J'ai déjà un compte, <a href=\"{{ path('app_login') }}\">me connecter</a>.</p>

{#    <script src=\"{{ asset('assets/js/custom2.js') }}\" defer></script>#}

    <script src=\"{{ asset('assets/js/email&pw.js') }}\" defer></script>

{% endblock %}
", "registration/register.html.twig", "C:\\laragon\\www\\testAuth\\templates\\registration\\register.html.twig");
    }
}
